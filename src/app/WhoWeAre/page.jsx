...
const StatCard = ({ number, text }) => {
    return (
        <div className="flex flex-col items-center justify-center aspect-square w-1/4 p-4 rounded-xl bg-[#BFBFBF33] hover:bg-[#BFBFBF1A]">
            <h3 className={`${number.length > 4 ? "text-xl xl:text-xl 2xl:text-5xl" : "text-2xl xl:text-xl 2xl:text-7xl"}    font-bold text-white`}>{number}</h3>
            <p className="text-sm xl:text-md 2xl:text-lg text-white text-center">{text}</p>
        </div>
    );
}
        ...
        <div className="mb-36">
            ...
            <div className="mx-20 lg:mx-40 xl:mx-64 mb-64 flex flex-row">
                <div className="flex flex-row w-full gap-4 lg:gap-8">
                    ...
                    <StatCard number="23" text="Indulge in the ultimate expression of sophistication" />
                    <StatCard number="+5" text="Indulge in the ultimate expression of sophistication" />
                </div>
            </div>
            ...
            <div className="mx-20 lg:mx-40 xl:mx-64 mb-20 h-64 flex flex-col">
                ...
                <div className="flex flex-row gap-16">
                    <div className="flex flex-col">
                        <h3 className="text-lg xl:text-xl 2xl:text-3xl text-[#C2C2C2] tracking-wider font-bold">2019</h3>
                    ...
                    <div className="flex flex-col">
                        <h3 className="text-lg xl:text-xl 2xl:text-3xl text-[#C2C2C2] tracking-wider font-bold">2020</h3>
                        <p className="leading-6 font-light">Indulge in the ultimate expression of sophistication with Luxe Reserve, where every sip embodies the essence of luxury. </p>
                        <div className="flex justify-center">
                            <svg width="2" height="280" xmlns="http://www.w3.org/2000/svg">
                                <line x1="1" y1="0" x2="1" y2="280" stroke="#585858" strokeWidth="2" strokeDasharray="32 8" />
                    ...
                    <div className="flex flex-col">
                        <h3 className="text-lg xl:text-xl 2xl:text-3xl text-[#C2C2C2] tracking-wider font-bold">2021</h3>
                        <p className="leading-6 font-light">Indulge in the ultimate expression of sophistication with Luxe Reserve, where every sip embodies the essence of luxury. </p>
                        <div className="flex justify-center">
                    ...
                    <div className="flex flex-col">
                        <h3 className="text-lg xl:text-xl 2xl:text-3xl text-[#C2C2C2] tracking-wider font-bold">2023</h3>
                        <p className="leading-6 font-light">Indulge in the ultimate expression of sophistication with Luxe Reserve, where every sip embodies the essence of luxury. </p>
                        <div className="flex justify-center">
                            <svg width="2" height="280" xmlns="http://www.w3.org/2000/svg">
                                <line x1="1" y1="0" x2="1" y2="280" stroke="#585858" strokeWidth="2" strokeDasharray="32 8" />
            ...
            <div className="mx-20 lg:mx-40 xl:mx-64 mb-96 flex flex-col">
                <h2 className="text-7xl mb-8 text-[#C2C2C2] tracking-wider">2024 - 2025</h2>
